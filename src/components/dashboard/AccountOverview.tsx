...
const AccountOverview = () => {
  ...
  const recentTransactions = transactions.slice(0, 4).map(transaction => ({
    ...
    // Outgoing transactions are negative
  ...
  return <div className="space-y-8">
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="mt-1 text-xs font-thin text-slate-900">Your live banking account with immediate processing</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        ...
        return <Card key={index} className="relative overflow-hidden border-0 shadow-lg hover:shadow-xl transition-all duration-300">
                ...
                <CardContent>
                  <div className="space-y-3">
                    <div className="text-3xl font-bold text-slate-800">
                      ...
                      {account.balance < 0 && balancesVisible && <span className="text-red-500 text-lg ml-2">CR</span>}
                    </div>
                    {balancesVisible && index === 0 && <div className="text-sm text-green-600 font-medium">
      ...
      <Card className="border-0 shadow-lg">
        ...
        <CardContent className="p-0">
          {recentTransactions.length === 0 ? <div className="p-8 text-center text-slate-500">
              ...
              {recentTransactions.map((transaction, index) => <div key={index} className="p-4 hover:bg-slate-50 transition-colors">
                  <div className="flex items-center justify-between">
                    <div className="flex-1">
                      <div className="flex items-center space-x-3">
                        <div className={`w-10 h-10 rounded-full flex items-center justify-center ${transaction.amount > 0 ? 'bg-emerald-100 text-emerald-600' : 'bg-red-100 text-red-600'}`}>
                    ...
                    <div className="text-right">
                      <div className={`font-bold text-lg ${transaction.amount > 0 ? "text-emerald-600" : "text-red-600"}`}>
